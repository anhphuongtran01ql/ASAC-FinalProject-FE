...
import './booking.css';
import {fetchPosts, createSchedule} from "../Services/Booking/bookingService";
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            <div className="container-doctor-detail">
                ...
                <div className="booking-create-container">
                    ...
                    <div style={{color: '#666'}}>Please fill in the information completely to save time for examination
                        procedures
                    </div>
