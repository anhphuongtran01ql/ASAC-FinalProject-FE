...
const SpecializationDetail = () => {
  ...
  const {
    ...
    queryKey: ["doctorsBySpecialization", id],
    queryFn: () => fetchDoctorsBySpecialization(id),
  });
    ...
    <>
      ...
      {isFetching || isLoading ? (
        ...
        <div className="container-specialization-detail flex-column">
          <Content
            className="site-layout-background background-image-specialization"
            style={{
              padding: 24,
              margin: 0,
              // minHeight: 280,
          ...
          >
            <div className="flex-column general-info-spe">
              <div>
                <div className="title-result margin-bottom">
                  {doctors.specializationName}
                </div>
                <div
                  style={{
                    height: onShowMoreClick ? "fit-content" : "100px",
                    overflow: "hidden",
                  }}
                ...
                <Button
                  ...
                  onClick={() => setOnshowMoreClick(!onShowMoreClick)}
                >
                  {onShowMoreClick ? "Show less" : "Show more"}
                </Button>
              </div>
            </div>
          </Content>
          <div style={{ margin: "0 30px" }}>
            ...
            >
              <div className="title-result">Outstanding Doctors</div>
